    ...
    <div>
      <div className="grid grid-cols-1 md:grid-cols-3 justify-evenly p-5 gap-3">
        <div>
          ...
          <p className="text-white cursor-pointer">
            This product developed by Jcc Technology Stream. by 2024 Students. This is a free open source product for students..
          </p>
        </div>
        <div>
          <h2 className="text-white text-[20px] shadow-sm cursor-pointer">
            Company - Jcc Technology Stream
          </h2>
      ...
      <div className="pt-4 pb-5">
        ...
        <p className="text-white mt-3 px-2 flex gap-2 items-center justify-start">
          <CopyrightIcon />
          Developed by Jcc Technology Stream, All rights reserved
        </p>
      </div>
    </div>
  );
